...
If you would like to take a look at the open source library I built, check out [`strema` on GitHub](https://github.com/alexharri/strema). It's a more mature version of what we implemented in this article.
