...
<SmallNote>This post uses VS Code, but <Command small faded>Command D</Command> can be used in other text editors such as Sublime and Atom. Other text editors will likely have analogous keyboard shortcuts.</SmallNote>
