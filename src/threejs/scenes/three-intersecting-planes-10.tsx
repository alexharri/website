...
export default createScene(({}) => {
  ...
  return (
    <>
      ...
      <MathLabel label="P_1" scale={1.3} position={point1} offset={[1.4, 1.2, 0]} normal={n1} />
      <MathLabel label="P_2" scale={1.3} position={point2} offset={[-1.4, -1.4, 0]} normal={n2} />
      <MathLabel label="P_3" scale={1.3} position={point3} offset={[1.2, 1.5, 0]} normal={n3} />
