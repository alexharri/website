...
export default createScene(
  ({}) => {
    ...
    const point1 = new THREE.Vector3(0, 0, 0.5);
    const point2 = new THREE.Vector3(0.25, 0, 0);
    const point3 = new THREE.Vector3(1.75, 0, 0);

    const n1 = new THREE.Vector3(0, 0.5, -1).normalize();
    const n2 = new THREE.Vector3(1, 0, 0).normalize();
    const n3 = new THREE.Vector3(1, 0, 0).normalize();
